                      ...
                      <TableCell>
                        <div className="flex items-center space-x-2">
                          <Avatar className="h-6 w-6">
                            <AvatarImage
                              src={`https://api.dicebear.com/7.x/initials/svg?seed=${product.seller}`}
                            />
                        ...
                        <Badge
                          variant={
                            product.status === 'Pending Review'
                              ? 'secondary'
                              : product.status === 'Quality Check'
                                ? 'default'
                                : product.status === 'Documentation Required'
                                  ? 'outline'
                                  : 'secondary'
                          }
                          className="text-xs"
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
            <div className="p-4 border rounded-lg space-y-2">
              ...
              <p className="text-xs text-muted-foreground">
                Product must meet minimum quality requirements and industry
                standards
              </p>
            </div>
            ...
            <div className="p-4 border rounded-lg space-y-2">
              ...
              <p className="text-xs text-muted-foreground">
                Complete product specifications, certifications, and compliance
                documents
              </p>
            </div>
            ...
            <div className="p-4 border rounded-lg space-y-2">
              ...
              <p className="text-xs text-muted-foreground">
                Accurate descriptions, proper categorization, and appropriate
                images
              </p>
            </div>
          </div>
