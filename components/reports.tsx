...
import { CalendarIcon, Download, FileText, BarChart3, TrendingUp, Users, Package } from "lucide-react";
    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
        {reportTemplates.map((template) => {
          ...
          return (
            <Card key={template.id} className={`border-0 ${template.bgColor} hover:shadow-md transition-shadow cursor-pointer`}>
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-muted-foreground">
                          {report.generatedDate} • {report.size} • {report.format}
                        </p>
                      </div>
                    </div>
                  </div>
